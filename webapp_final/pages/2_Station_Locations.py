...
st.latex("""This page presents the **distribution of H_2 stations** according to the scenario considered (optimistic, moderate or conservative) and the year (2030 or 2040).
