...
def load_data():
    data = pd.read_csv(
        "/Users/antoinerazeghi/Documents/Projects/AirLiquide/airliquide/hub_clustering/donnees_entrepot_location.csv"
    )
...
def _load_region_transco():
    xls = pd.ExcelFile(
        "/Users/antoinerazeghi/Documents/Projects/AirLiquide/airliquide/hub_clustering/donnees_entrepots.xls"
    )
